...
#define JSON_S_SIZE     4096           /*  Indica el tamaño de las lecturas del Socket de servidor. */
...
#define JSON_FILE_NAME   "covid_JSON.txt" /*  Indica el nombre del archivo donde se encuentra el código fuente del servidor JSON. */
