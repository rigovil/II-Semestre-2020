...
#define NUMBER_SERVERS  1               /*  Indica el número de servidores a los que se les va a solicitar información. */
...
#define NEW_LINE        '\n'            /*  Almacena un caracter de salto de línea. */
...
#define PARSED_FILE		"covid.csv"	    /*  Indica el nombre del archivo donde se encuentran los datos filtrados. */
